...
export const handler = async (event) => {
	const sqlParams = {
		...
		sql: 'UPDATE public.cellars SET cellar_name = :cellar_name, cellar_description = :cellar_description WHERE cellar_id = :cellar_id AND user_id = :user_id'
	};
	...
	if (response.numberOfRecordsUpdated === 0) {
		throw new Error('Cellar was not updated because it does not exist');
	}
};
